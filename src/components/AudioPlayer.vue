    ...
    <div class="audio-player__now-playing">
      ...
      <div class="audio-player__control">
        <button class="audio-player__control-button">
          <img src="../assets/icons/prev.png" class="audio-player__play-icon" @click="changeSong(selectedSongIndex - 1)">
        </button>
        ...
        <button class="audio-player__control-button">
          <img src="../assets/icons/next.png" class="audio-player__play-icon" @click="changeSong(selectedSongIndex + 1)">
        </button>
      </div>
...
<script>
  export default {
    ...
    mounted() {
      ...
      console.log(this.$refs.playlistContainer.clientHeight)
      this.$refs.audio.onloadeddata = () => {
        this.timeDuration = this.$refs.audio.duration
      }
